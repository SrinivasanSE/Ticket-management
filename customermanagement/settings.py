...
SECRET_KEY = 'ml5=g-8gj=q1+-15$7@f)ccn1kp_rsdt#f5ga62ho9$j=%)8%d'
...
AUTH_USER_MODEL = 'administer.User' #
MIDDLEWARE = [
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'seenusrini1999@gmail.com'
EMAIL_HOST_PASSWORD = 'codersrisee'
